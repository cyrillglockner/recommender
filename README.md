...
The Recommender App is a versatile tool designed to create connections of many different use-cases. In this case we have a fictional database of members of a climate action community that look for valuable connections within the network. 
